...
func (x *DriverRequest) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
const file_proto_driver_proto_rawDesc = "" +
	"\n" +
	"\x12proto/driver.proto\x12\x06driver\"G\n" +
	"\rDriverRequest\x12\x19\n" +
	"\border_id\x18\x01 \x01(\tR\aorderId\x12\x1b\n" +
	"\tdriver_id\x18\x02 \x01(\tR\bdriverId\"(\n" +
	"\x0eDriverResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status2N\n" +
	"\rDriverService\x12=\n" +
	"\fAssignDriver\x12\x15.driver.DriverRequest\x1a\x16.driver.DriverResponseB\x10Z\x0e./proto/driverb\x06proto3"
...
var file_proto_driver_proto_depIdxs = []int32{
	0, // 0: driver.DriverService.AssignDriver:input_type -> driver.DriverRequest
	1, // 1: driver.DriverService.AssignDriver:output_type -> driver.DriverResponse
